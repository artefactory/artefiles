...
-- Folding (using treesitter when available, fallback to indent)
vim.opt.foldmethod = "indent"    -- Use indent folding by default
...
vim.api.nvim_create_autocmd("User", {
  pattern = "LazyDone",
  callback = function()
    -- Only set treesitter folding if treesitter is available
